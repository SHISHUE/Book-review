...
import { createReview, editReviews, deleteReview, createComment, deleteComment, editComments } from "../../services/operations/reviewAPI";
...
function BookDetails() {
  ...
  const [reviewComment, setReviewComment] = useState<boolean>(false);
  ...
  const editCommentHandler = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();

    if (commentId && editComment && token)
